    ...
    <div className="space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-8">
        ...
        <div className="space-y-4 sm:space-y-8 lg:col-span-1">
          <div className="glass-card p-4 sm:p-6 sm:p-8 text-center relative overflow-hidden">
            <div className="absolute -top-24 -right-24 w-48 h-48 bg-primary/5 rounded-full blur-3xl pointer-events-none"></div>
            <div className="w-16 h-16 sm:w-24 sm:h-24 bg-primary/10 border border-primary/20 text-primary rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 relative z-10 shadow-[0_0_15px_rgba(0,96,100,0.1)]">
              <UserCircle className="w-8 h-8 sm:w-12 sm:h-12" />
            </div>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-display font-medium text-[#171c1f] capitalize tracking-tight relative z-10">{p.nama}</h2>
            ...
            <div className="mt-4 sm:mt-8 border-t border-[#bdc8cb]/30 pt-4 sm:pt-8 space-y-3 sm:space-y-5 text-left relative z-10">
              <div className="flex items-center text-xs sm:text-sm bg-white/40 backdrop-blur-[12px] p-2.5 sm:p-3 rounded-xl border border-[#bdc8cb]/20">
                <div className="p-1.5 sm:p-2 bg-[#f0f4f8] rounded-lg mr-3 sm:mr-4"><MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-primary" /></div>
                <div>
              ...
              <div className="flex items-center text-xs sm:text-sm bg-white/40 backdrop-blur-[12px] p-2.5 sm:p-3 rounded-xl border border-[#bdc8cb]/20">
                <div className="p-1.5 sm:p-2 bg-[#f0f4f8] rounded-lg mr-3 sm:mr-4"><Phone className="w-4 h-4 sm:w-5 sm:h-5 text-primary" /></div>
                <div>
                  <p className="text-gray-500 font-medium text-[10px] sm:text-xs mb-0.5">Telepon</p>
                  <p className="text-[#171c1f] font-mono font-semibold text-xs sm:text-sm">{p.nomor_telepon}</p>
                </div>
              </div>
              <div className="flex items-center text-xs sm:text-sm bg-white/40 backdrop-blur-[12px] p-2.5 sm:p-3 rounded-xl border border-[#bdc8cb]/20">
                <div className="p-1.5 sm:p-2 bg-[#f0f4f8] rounded-lg mr-3 sm:mr-4"><Briefcase className="w-4 h-4 sm:w-5 sm:h-5 text-primary" /></div>
                <div>
                  <p className="text-gray-500 font-medium text-[10px] sm:text-xs mb-0.5">Pekerjaan</p>
                  <p className="text-[#171c1f] font-semibold text-xs sm:text-sm">{p.pekerjaan}</p>
                </div>
              </div>
              <div className="flex items-center text-xs sm:text-sm bg-white/40 backdrop-blur-[12px] p-2.5 sm:p-3 rounded-xl border border-[#bdc8cb]/20">
                <div className="p-1.5 sm:p-2 bg-[#f0f4f8] rounded-lg mr-3 sm:mr-4"><UserCircle className="w-4 h-4 sm:w-5 sm:h-5 text-primary" /></div>
                <div>
                  <p className="text-gray-500 font-medium text-[10px] sm:text-xs mb-0.5">Usia</p>
                  <p className="text-[#171c1f] font-semibold text-xs sm:text-sm">{p.usia} Tahun</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-2">
          <div className="glass-card p-4 sm:p-6 md:p-10">
            <h3 className="text-lg sm:text-2xl font-display font-medium text-primary mb-4 sm:mb-8">Riwayat Hasil Tes</h3>
            
            <div className="space-y-4 sm:space-y-5">
              {history.map(h => (
                <div key={h.id} className="solid-card p-4 sm:p-5 md:p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center hover:border-primary/30 border border-transparent transition-all duration-300 hover:-translate-y-1 group">
                  <div className="flex-1 mb-5 sm:mb-0">
                    <div className="flex items-center">
                      ...
                      <h4 className="font-display font-bold text-base sm:text-lg text-[#171c1f] group-hover:text-primary transition-colors">{h.snapshot_tes.nama}</h4>
                    </div>
                  ...
                  <div className="flex items-center space-x-3 sm:space-x-6 w-full sm:w-auto mt-3 sm:mt-0 pt-3 sm:pt-0 border-t sm:border-t-0 border-[#bdc8cb]/30">
                    <div className="text-center">
                      <p className="text-[10px] sm:text-xs text-gray-500 font-medium uppercase tracking-widest">Skor</p>
                      <p className="text-xl sm:text-2xl font-display font-bold text-primary mt-0.5">{h.skor_akhir}</p>
                    </div>
